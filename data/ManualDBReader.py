...
class ManualDBReader(object):
    ...
    def get(self, read_image=False):
        ...
        [joint2d, hand_side, img_dir, head_size] = tf.train.slice_input_producer([self.joints2d, self.hand_sides, self.img_dirs, self.head_sizes], shuffle=False)
        ...
        if self.hand_crop:
            ...
            if self.crop_scale_noise:
                crop_scale_noise = tf.squeeze(tf.random_uniform([1], minval=0.9, maxval=1.4))    
