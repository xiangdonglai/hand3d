...
openpose_dataset = OpenposeSTBReader(mode='evaluation', shuffle=False, hand_crop=True, use_wrist_coord=False)
...
coord3d_pred, _, _ = net._inference_pose3d(scoremap_pooled, openpose_data['hand_side'], evaluation, train=True)
...
net.init(sess, weight_files=['./weights/handsegnet-rhd.pickle',
                             './weights/posenet3d-my-jft-openpose.pickle'], exclude_var_list=['HandSegNet', 'PoseNet2D'])

util = EvalUtil()
# iterate dataset
for i in range(dataset.num_samples):
    # get prediction
    keypoint_xyz21, keypoint_vis21, keypoint_scale, keypoint_uv21_v, coord3d_pred_v, image_scaled_v = \
